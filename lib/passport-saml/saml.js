...
SAML.prototype.getElementString = function(parentElement, elementSubString) {
  var parentElementString = JSON.stringify(parentElement);
  var pattern = new RegExp("(.*)" + elementSubString, "m");
  var firstMatch = parentElementString.match(pattern)[1];
  var secondMatch = firstMatch.substr(firstMatch.lastIndexOf('"'));
  var elemName = secondMatch.substr(1) + elementSubString;
  return elemName;
};
...
SAML.prototype.getElement = function (parentElement, elementName) {
  ...
  var firstMatch = parentElementString.match(pattern)[1];
  var secondMatch = firstMatch.substr(firstMatch.lastIndexOf('"'));
  var elemName = secondMatch.substr(1) + elementName;
